"""
    THIS IMPLEMENTATION USES KERAS AND WAS ABANDONED DUE TO A BUG ON KERAS WHEN MULTIPLE THREADS
    EXECUTE DIFFERENT TENSORFLOW SESSIONS WITH DIFFERENT GRAPHS (BY ITS TURN, MULTIPLE THREADS ARE NEEDED DUE TO
    A BUG IN THE HFO IMPLEMENTATION THAT CAUSES EXCEPTIONS WHEN MULTIPLE AGENTS ARE EXECUTED IN A SINGLE THREAD).
    THE VERSION ACTUALLY USED IN THE EXPERIMENTS IS WRITTEN IN PURE TENSORFLOW (c51agent.py)
